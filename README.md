# Openfeature JAVA provider for Harness Feature Flags

This repository contains all the details that'll help you to develop OpenFeature JAVA provider for Harness Feature Flags! 
